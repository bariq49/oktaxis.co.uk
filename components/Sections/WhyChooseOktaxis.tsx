...
const WhyChooseOktaxis = () => {
  return (
    <section className="relative bg-gradient-to-r from-green-100 to-green-50 text-black py-16 overflow-hidden">
      <div className="absolute inset-y-0 left-0 w-1/4 bg-green-700/20 rounded-r-full"></div>
      <div className="absolute inset-y-0 right-0 w-1/4 bg-green-700/20 rounded-l-full"></div>
      ...
      <div className="relative container mx-auto px-6 md:px-12 lg:px-20 z-10">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 mb-12">
          <ul className="list-disc list-inside text-gray-700 space-y-4">
            <li>
              <span className="text-green-700 font-semibold">Book Early:</span> Secure your slot and enjoy the best pricing by reserving in advance.
            </li>
            <li>
              <span className="text-green-700 font-semibold">Read Reviews:</span> Check customer feedback on platforms like Google or TripAdvisor to confirm reliability.
            </li>
            <li>
              <span className="text-green-700 font-semibold">Compare Services:</span> Evaluate features and pricing to select the best option.
            </li>
            <li>
              <span className="text-green-700 font-semibold">Provide Accurate Flight Details:</span> Ensure timely service by sharing your flight schedule.
            </li>
            <li>
              <span className="text-green-700 font-semibold">Opt for Meet and Greet Services:</span> Our drivers will be waiting for you at arrivals with a sign for a seamless experience.
            </li>
          </ul>
        </div>
