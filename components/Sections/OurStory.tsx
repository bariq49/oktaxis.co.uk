        ...
        <Card className="border-none shadow-none">
          <CardContent className="p-8">
            <div className="text-center space-y-6">
              ...
              <span className="text-blue-700">Manchester</span> Airport Taxi/ Instant <span className="text-blue-700">Manchester Airport</span> Transfer Quote
              </h1>
              <div className="space-y-4 text-gray-600">
                ...
                <p>
                  <span className="font-bold text-blue-700">OKTAXIS:</span> Offers pre-booked vehicles, private car services, and hourly services.
                </p>
                <p>
                  <span className="font-bold text-blue-700">OKTAXIS:</span> Offers Manchester Airport transfers and Liverpool Airport Transfers.
                </p>
              </div>
            </div>
          </CardContent>
