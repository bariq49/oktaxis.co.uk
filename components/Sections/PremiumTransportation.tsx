    ...
    <section className="bg-gradient-to-br from-gray-50 to-green-50 text-black py-12">
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-4 mb-6">
          ...
          <li><span className="text-green-700 font-semibold">Real-Time Tracking:</span> Track your driver’s location and estimated arrival time through our intuitive system.</li>
